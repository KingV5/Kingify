...
return game:HttpGet('https://api.github.com/repos/KingV5/Kingify/contents/profiles/premade?ref=' .. commit)
    end)
            ...
            for _, file in pairs(files) do
                if file.name and file.name:find('.txt') and file.name ~= 'commit.txt' then
                    ...
                    if not isfile(filePath) then
                      local dl = file.download_url or ('https://raw.githubusercontent.com/KingV5/Kingify/' .. commit .. '/profiles/premade/' .. file.name)
...
if not shared.VapeDeveloper then
	...
	return game:HttpGet('https://github.com/KingV5/Kingify')
	end)
